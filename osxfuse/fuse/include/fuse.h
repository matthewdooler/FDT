...
#ifdef __APPLE__
	int (*setxattr) (void *, const char *, const char *, const char *, size_t, int, uint32_t);
#else
	int (*setxattr) (void *, const char *, const char *, const char *, size_t, int);
#endif
#ifdef __APPLE__
	int (*getxattr) (void *, const char *, const char *, char *, size_t, uint32_t);
#else
...
#ifdef __APPLE__
    int (*reserved00) (void *, void *, void *, void *, void *, void *, void *, void *, void *);
    int (*reserved01) (void *, void *, void *, void *, void *, void *, void *, void *, void *);
    int (*reserved02) (void *, void *, void *, void *, void *, void *, void *, void *, void *);
    int (*reserved03) (void *, void *, void *, void *, void *, void *, void *, void *, void *);
    int (*reserved04) (void *, void *, void *, void *, void *, void *, void *, void *, void *);
    int (*reserved05) (void *, void *, void *, void *, void *, void *, void *, void *, void *);
    int (*reserved06) (void *, void *, void *, void *, void *, void *, void *, void *, void *);
    int (*reserved07) (void *, void *, void *, void *, void *, void *, void *, void *, void *);
    int (*reserved08) (void *, void *, void *, void *, void *, void *, void *, void *, void *);
    int (*reserved09) (void *, void *, void *, void *, void *, void *, void *, void *, void *);
    int (*reserved10) (void *, void *, void *, void *, void *, void *, void *, void *, void *);
    int (*setvolname) (void *, const char *);
	int (*exchange) (void *, const char *, const char *, unsigned long);
    int (*getxtimes) (void *, const char *, struct timespec *bkuptime, struct timespec *crtime);
    int (*setbkuptime) (void *, const char *, const struct timespec *tv);
    int (*setchgtime) (void *, const char *, const struct timespec *tv);
    int (*setcrtime) (void *, const char *, const struct timespec *tv);
	int (*chflags) (void *, const char *, uint32_t);
	int (*setattr_x) (void *, const char *, struct setattr_x *);
	int (*fsetattr_x) (void *, const char *, struct setattr_x *, struct fuse_file_info *);
#endif /* __APPLE__ */
};
 ...
 */
int fuse_op_wrapper_getattr(void *fs_ptr, const char *path, struct stat *buf);
int fuse_op_wrapper_fgetattr(void *fs_ptr, const char *path, struct stat *buf, struct fuse_file_info *fi);
int fuse_op_wrapper_rename(void *fs_ptr, const char *oldpath, const char *newpath);
#ifdef __APPLE__
int fuse_op_wrapper_setvolname(void *fs_ptr, const char *volname);
int fuse_op_wrapper_exchange(void *fs_ptr, const char *oldpath, const char *newpath, unsigned long flags);
#endif
int fuse_op_wrapper_unlink(void *fs_ptr, const char *path);
int fuse_op_wrapper_rmdir(void *fs_ptr, const char *path);
int fuse_op_wrapper_symlink(void *fs_ptr, const char *linkname, const char *path);
int fuse_op_wrapper_link(void *fs_ptr, const char *oldpath, const char *newpath);
...
int fuse_op_wrapper_read(void *fs_ptr, const char *path, char *buf, size_t size, off_t off, struct fuse_file_info *fi);
int fuse_op_wrapper_write(void *fs_ptr, const char *path, const char *buf, size_t size, off_t off, struct fuse_file_info *fi);
...
int fuse_op_wrapper_statfs(void *fs_ptr, const char *path, struct statvfs *buf);
int fuse_op_wrapper_opendir(void *fs_ptr, const char *path, struct fuse_file_info *fi);
int fuse_op_wrapper_readdir(void *fs_ptr, const char *path, void *buf, fuse_fill_dir_t filler, off_t off, struct fuse_file_info *fi);
...
int fuse_op_wrapper_lock(void *fs_ptr, const char *path, struct fuse_file_info *fi, int cmd, struct flock *lock);
#ifdef __APPLE__
...
int fuse_op_wrapper_truncate(void *fs_ptr, const char *path, off_t size);
int fuse_op_wrapper_ftruncate(void *fs_ptr, const char *path, off_t size, struct fuse_file_info *fi);
...
int fuse_op_wrapper_readlink(void *fs_ptr, const char *path, char *buf, size_t len);
int fuse_op_wrapper_mknod(void *fs_ptr, const char *path, mode_t mode, dev_t rdev);
...
void fuse_op_wrapper_destroy(void *fs_ptr, void *);
int fuse_op_wrapper_setattr_x(void *, const char *, struct setattr_x *);
int fuse_op_wrapper_fsetattr_x(void *, const char *, struct setattr_x *, struct fuse_file_info *);
