...
readonly M_CONF_TMPDIR=$CURRENT_DIR/out
echo "Output will be placed in" $M_CONF_TMPDIR
ln -f ../wizard_tests.c fuse/lib/wizard_tests.c
ln -f ../testsuite_run.c fuse/lib/testsuite_run.c
